...
var breizhjugApp = angular.module('breizhjugApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'breizhjugAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
